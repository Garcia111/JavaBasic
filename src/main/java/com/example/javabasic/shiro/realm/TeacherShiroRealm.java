...
import com.example.javabasic.shiro.entity.Teacher;
import com.example.javabasic.shiro.service.TeacherService;
...
public class TeacherShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        String teacherName =  userToken.getUsername();
        Teacher teacher = teacherService.findByTeacherName(teacherName);
