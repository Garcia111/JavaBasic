...
import easy_excel.EasyExcelValiHelper;
import easy_excel.model.ExcelCheckResult;
import easy_excel.model.ExcelCheckErrDto;
import easy_excel.service.ExcelCheckManager;
import lombok.Data;
...
public class EasyExcelListener <T>  extends AnalysisEventListener<T> {
    ...
    /**
     * @description: 校验excel头部格式，上传文件实体与实际上传文件表头必须完全匹配
    ...
    public Map<Integer,String> getIndexNameMap(Class clazz) throws NoSuchFieldException {
        ...
        for (int i = 0; i <fields.length ; i++) {
            ...
            //判断实体类中属性是否被ExcelProperty注解标记，被标记则是表头列
